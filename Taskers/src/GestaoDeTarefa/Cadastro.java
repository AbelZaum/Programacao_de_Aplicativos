...
public class Cadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GestaoDeTarefa/tks2.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (senha.equals(new String(jPasswordField2.getPassword()))) {
            boolean cadastradoComSucesso = usuarioDAO.cadastrarUsuario(nomeUsuario, senha);
            ...
            if (cadastradoComSucesso) {
                ...
                JOptionPane.showMessageDialog(this, "Nome de usuário já existe. Escolha outro nome de usuário.");
            }
        } else {
            JOptionPane.showMessageDialog(this, "As senhas não correspondem. Verifique sua senha.");
        }
