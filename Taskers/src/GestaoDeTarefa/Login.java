...
import GestaoDeTarefa.CadastroService;  // Substitua pelo nome do seu pacote
...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean credenciaisCorretas = cadastroService.verificarCredenciais(nomeUsuario, senha);

        if (credenciaisCorretas) {
            // Credenciais corretas; você pode abrir o sistema de gerenciamento de tarefas aqui
